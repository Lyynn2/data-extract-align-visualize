...
#include "ecg_test.h" // for ECG_I2C_BUS
#include "ecg_gpio_expander.h" // for reading the ADC data-ready bit
...
#define ECG_ADC_CHANNEL_ECG          0 // 0
#define ECG_ADC_CHANNEL_ELECTRODE_1  2 // 2
#define ECG_ADC_CHANNEL_ELECTRODE_2  3 // 3
